rm(list = ls())
setwd("C:/Users/xueli/Dropbox/2020_Summer/CIS8695/1 Regression")
...
library(dummies)
train.df<-data.frame(Fuel_Type=train.df$Fuel_Type,
                   dummy.data.frame(train.df, names = "Fuel_Type",
                    sep=".",dummy.classes =c("Diesel", "Petrol", "CNG")))
car.lm.dm <- lm(Price ~ Age_08_04+KM+Fuel_Type.CNG+Fuel_Type.Diesel+HP+Met_Color+
