...
library(class)
library(kknn)
Loan.df <- read.csv("/Users/bhavin/Documents/Fall 2021 - Semester (M1)/CIS 8695 - Big Data Analytics (Ling Xue)/4.NB, SVM and KNN/CSV_UniversalBank.csv")
...
library(kknn)
set.seed(123)
kknn.train <- train.knn(Personal.Loan ~ ., data = train.loan, kmax = 25, 
                           distance = 2, 
